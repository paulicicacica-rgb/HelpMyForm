...
GROUPS = {
    ...
    # Existing English-only clusters
...
def to_url(path):
    ...
    # language homepages e.g. ro/index -> /ro
    if clean.endswith("/index"):
        clean = clean[:-6]  # strip /index
    return BASE + "/" + clean
